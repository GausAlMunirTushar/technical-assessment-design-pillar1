...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative w-full max-w-[1200px] mx-auto px-4 pt-2 sm:pt-6 pb-0 flex flex-col items-center">
      {/* Top Greeting Badge */}
      ...
      <div className="relative text-center max-w-[850px] mb-4 sm:mb-8 z-10">
        ...
        <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-[72px] font-extrabold text-[#111111] tracking-tight leading-[1.08]">
      ...
      <div className="w-full max-w-[1150px] grid grid-cols-1 md:grid-cols-12 items-center gap-4 relative mt-2 sm:-mt-6">
        ...
        <div className="col-span-1 md:col-span-6 flex justify-center items-end z-10">
          <div className="relative w-[300px] xs:w-[360px] sm:w-[460px] md:w-[520px] aspect-[4/3.2] flex justify-center items-end">
            {/* Orange Arch Background Shape */}
            <div className="absolute bottom-0 w-[260px] xs:w-[320px] sm:w-[400px] md:w-[460px] h-[170px] xs:h-[210px] sm:h-[260px] md:h-[300px] bg-accent-orange rounded-t-full shadow-md" />
