	...
	return (
		<div className="relative group w-full min-w-70 xs:min-w-[300px] md:min-w-0 bg-white/4 border border-white/15 hover:border-white/25 rounded-[28px] xs:rounded-[32px] sm:rounded-[36px] md:rounded-[40px] flex flex-col justify-between backdrop-blur-md shadow-2xl transition-all duration-300 hover:-translate-y-2 snap-start overflow-hidden">
			...
			<div className="p-5 xs:p-6 sm:p-7 pb-0">
				...
				<div className="w-full h-px bg-white/15 mt-3.5 sm:mt-4 mb-3 sm:mb-4" />
			</div>
			...
			<div className="relative w-full px-3 xs:px-4 sm:px-5 pb-3 xs:pb-4 sm:pb-5 mt-2">
				...
				<div className="w-[80%] h-6 bg-white/15 rounded-t-[20px] sm:rounded-t-3xl mx-auto -mb-3 opacity-60 pointer-events-none" />

				{/* Stacked Card Layer 2 (Middle tab) */}
				<div className="w-[90%] h-6 bg-white/25 rounded-t-3xl sm:rounded-t-[28px] mx-auto -mb-3 opacity-90 relative z-10 pointer-events-none" />

				{/* Stacked Card Layer 1 (Front Main Showcase Card) */}
				<div className="relative z-20 w-full">
					<div className="relative w-full aspect-[1.22] service-card-cutout rounded-t-3xl sm:rounded-t-[28px] rounded-bl-3xl sm:rounded-bl-[28px] overflow-hidden bg-[#F0EAE1] shadow-xl">
						<Image
							src={imageSrc}
							alt={altText}
							fill
